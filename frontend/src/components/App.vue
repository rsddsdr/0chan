    ...
    export default {
        ...
        created() {
            ...
            $(document).click(event => {
                ...
                if (event.target && event.target.tagName && event.target.tagName.toLowerCase() === 'a' && event.target.className.toLowerCase() === 'boardref') {
                    event.preventDefault();
                    const address = event.target.attributes.getNamedItem('data-board').value;
