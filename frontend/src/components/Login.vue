    ...
    export default {
        ...
        data () {
            return {
                ...
                register: {
                    login: '', password: '', password2: '', email: '', invite: ''
                },
                registerErrors: {},
            }
        },
        created() {
            ...
            if (this.invite) {
                ...
                this.register['invite'] = this.invite
            }
        },
        methods: {
            doLogin() {
            ...
            doRegister() {
                ...
                User.register(this.register.login, this.register.password, this.register.email, this.register.invite)
                    .then((response) => {
                        let data = response.data;
                        if (data['form-errors']) {
