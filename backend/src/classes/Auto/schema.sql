...
CREATE TABLE "invite" (
    ...
    "used_by_id" BIGINT NULL REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    PRIMARY KEY("id")
);
...
CREATE TABLE "rate" (
    "id" BIGINT NOT NULL default nextval('rate_id'),
...
CREATE TABLE "board" (
    ...
    "imrequired" BOOLEAN NOT NULL DEFAULT FALSE,
    "textboard" BOOLEAN NOT NULL DEFAULT FALSE,
    "sage" BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE "post" (
    ...
    "identity_id" BIGINT NULL REFERENCES "user_identity"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    PRIMARY KEY("id")
);
